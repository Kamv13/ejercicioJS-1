...
let inputX1 = (-NumberB + Math.sqrt(NumberB**2 - 4*NumberA*NumberC)) / (2*NumberA);
let inputX2 = (-NumberB - Math.sqrt(NumberB**2 - 4*NumberA*NumberC)) / (2*NumberA);


  document.getElementById("valorX1").value = inputX1
  document.getElementById("valorX2").value = inputX2
